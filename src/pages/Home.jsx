    ...
    return (
      <div className="flex justify-center items-center w-screen h-screen bg-secondary">
        <Helmet prioritizeSeoTags>
          <title>{t("Home")} - {t("My Love Car")}</title>
          <meta name="description" content={t("Welcome to My Love Car. Discover our car maintenance, inspection, and renewal services. Your trusted automotive partner.")} />
          <meta name="keywords" content={t("home, car maintenance, inspection, renewal, automotive services")}/>
          <meta property="og:title" content={`${t("Home")} - ${t("My Love Car")}`} />
          <meta property="og:description" content={t("Welcome to My Love Car. Discover our car maintenance, inspection, and renewal services. Your trusted automotive partner.")} />
  ...
  return(
    <>
      <Helmet prioritizeSeoTags>
        <title>{t("Home")} - {t("My Love Car")}</title>
        <meta name="description" content={t("Welcome to My Love Car. Discover our car maintenance, inspection, and renewal services. Your trusted automotive partner.")} />
        <meta name="keywords" content="home, car maintenance, inspection, renewal, automotive services" />
        <meta property="og:title" content={`${t("Home")} - ${t("My Love Car")}`} />
        <meta property="og:description" content={t("Welcome to My Love Car. Discover our car maintenance, inspection, and renewal services. Your trusted automotive partner.")} />
        <meta property="og:type" content="website" />
      </Helmet>
