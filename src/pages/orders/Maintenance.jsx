      ...
      <section className="w-9/12 mx-auto flex flex-col justify-center items-center">
        ...
        <form className="flex flex-col w-full md:justify-center md:items-center" onSubmit={handleSubmit}>
          ...
          <label className="form-control w-full max-w-xs"> 
            ...
            <Select closeOnClickInput values={selectedOilOptions} defaultValue={selectedOilOptions} itemRenderer={itemRenderer} dropdownGap={6} direction="rtl" className="bg-base-100 border border-gray-600 form-control w-20 max-w-xs md:self-center" style={{borderColor: "gray", maxWidth: "20rem", background: "#1E1E1E", color: "#fff", borderRadius: "0.4rem"}} placeholder="Oils"  searchable={false} color="#E45A00" options={maintenanceOptionsData.oils} multi labelField="name" valueField="id" name="oils" onChange={handleOilsChange} />
          </label>
          ...
          <label className="form-control w-full max-w-xs"> 
            ...
            <Select closeOnClickInput values={selectedRepairTypeOptions} defaultValue={selectedRepairTypeOptions} itemRenderer={itemRenderer} dropdownGap={6} direction="rtl" className="bg-base-100 border border-gray-600 form-control w-20 max-w-xs md:self-center" style={{borderColor: "gray", maxWidth: "20rem", background: "#1E1E1E", color: "#fff", borderRadius: "0.4rem"}} placeholder="Repair Types"  searchable={false} color="#E45A00" options={maintenanceOptionsData.repairTypes} multi labelField="name" valueField="id" name="repairTypes" onChange={handleRepairTypesChange} />
          </label>
