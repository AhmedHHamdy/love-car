    ...
    <>
      <div className="navbar bg-base-100 w-10/12 mx-auto px-0 py-4">
       ...
       {!token && <div className="navbar-end">
          <Link to="/login" className="btn h-2 min-h-[2rem] md:btn md:rounded-full md:bg-primary md:text-accent bg-primary text-base px-6 md:text-xl rounded-full md:px-10 text-accent leading-none lg:px-5 xl:px-6">{t("Login")}</Link>
        </div>}
